    ...
    <div>
      <form onSubmit={submit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mb-6">
          ...
          <input className="shadow appearance-none border text-gray rounded w-full py-2 px-3 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="number" name="classificationOrder" onChange={(e) => onChange(e)} placeholder="Classification Order" />
        </div>
